      ...
      <el-col :span="4" :style="min_height">
        <el-menu default-active="1" class="el-menu-vertical-demo">
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="2-3" @click="gopath('foodList')">食品列表</el-menu-item>
          ...
          <el-submenu index="3">
            ...
            <el-menu-item index="3-1" @click="gopath('addShop')">添加商铺</el-menu-item>
          ...
          <el-submenu index="4">
            ...
            <el-menu-item index="4-1" @click="gopath('user')">用户分布</el-menu-item>
          </el-submenu>
          <el-submenu index="5">
            <template slot="title">
            ...
            <el-menu-item index="5-1" @click="gopath('edit')">文本编辑</el-menu-item>
          </el-submenu>
          <el-submenu index="6">
            <template slot="title">
